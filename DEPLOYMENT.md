...
4. Service Worker wird registriert und verwendet Cache `secret-circle-v16`.
...
10. Datenschutzseite, Live-Einrichtungslogik, Karten-Sichtschutz und Wake-Lock-Modul sind offline erreichbar.
...
12. Während der Diskussionsrunde bleibt der Bildschirm auf unterstützten Geräten aktiv; beim Wechsel zur Abstimmung wird die Sperre freigegeben.
13. Auf Geräten ohne Wake-Lock-Unterstützung bleibt der gesamte Spielablauf ohne Fehlermeldung nutzbar.
14. Nach einer Aktualisierung bleibt nur Cache `secret-circle-v16` bestehen.
