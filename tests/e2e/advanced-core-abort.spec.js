...
const ACTIVE_KEY = 'secret-circle-party-advanced-active-v1';
...
for (const gameId of GAMES) {
  test(`${gameId} abort removes only the active session and does not count a completed play`, async ({ page }) => {
    await seed(page);
