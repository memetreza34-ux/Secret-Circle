(function (root, factory) {
  ...
  const viralContent = {
    ...
    'higher-lower': {
      ...
      Sport: [['Spieler eines Fußballteams auf dem Feld', 11], ['Ecken eines Fünfecks', 5], ['Punkte für einen Touchdown', 6], ['Löcher einer normalen Golfrunde', 18], ['Meter eines Marathonlaufs gerundet', 42195], ['Bahnen einer typischen 400-Meter-Leichtathletikanlage', 8], ['Gewinnsätze in einem Best-of-five-Tennismatch', 3], ['Spieler eines Basketballteams auf dem Feld', 5]],
