...
production_js = [
    ...
    'party-wave-one-writing-catalog.js', 'party-release-structure.js', 'party-filter-state.js',
...
required_contract_files = [
    ...
    'tests/e2e/quick-background-pause.spec.js', 'tests/e2e/wave-one-quiz.spec.js',
    'tests/e2e/wave-one-imposter.spec.js', 'tests/e2e/wave-one-writing.spec.js'
]
...
for marker in (
    ...
    'Expansion Wave 1 Imposter – v62', 'Expansion Wave 1 Writing – v63'
):
...
contracts = {
    ...
    'quick-loader.js': ["REPLACEMENT_GUARD_SOURCE = 'quick-session-replacement-guard.js'","WAVE_ONE_SOURCE = 'party-wave-one-modes.js'","WAVE_ONE_IMPOSTER_SOURCE = 'party-wave-one-imposter-modes.js'","WAVE_ONE_WRITING_SOURCE = 'party-wave-one-writing-modes.js'",'catalog.waveOneWritingGameIds?.includes(gameId)','catalog.waveOneImposterGameIds?.includes(gameId)','catalog.waveOneQuizGameIds?.includes(gameId)','replacementGuardReady = false','plan.push(REPLACEMENT_GUARD_SOURCE)','version: 10'],
    'party-wave-one-catalog.js': ["id: 'party-quiz'","id: 'fact-or-fake'","id: 'undercover-similar-word'","id: 'no-word-imposter'",'waveOneQuizGameIds','waveOneImposterGameIds','waveOneGameIds','quickGameIds','version: 3'],
    'party-wave-one-imposter-catalog.js': ['Konsolidierter Wave-1-Katalog fehlt.','waveOneImposterGameIds','return base;'],
    'party-wave-one-writing-catalog.js': ["id: 'fill-blank-battle'","id: 'who-wrote-it'",'waveOneWritingGameIds','waveOneGameIds','quickGameIds','version: 4'],
    ...
    'party-wave-one-imposter-modes.js': ["ACTIVE_KEY = 'secret-circle-party-quick-active-v1'",'waveOneImposterGameIds',"L.completionId('wave1-imposter', game.id, active.sessionId)",'function concealPrivate()',"addEventListener('blur', concealPrivate)",'function resolveVotes()','function submitGuess()'],
    'party-wave-one-writing-modes.js': ["ACTIVE_KEY = 'secret-circle-party-quick-active-v1'",'waveOneWritingGameIds',"L.completionId('wave1-writing', game.id, active.sessionId)",'function concealEntry()',"addEventListener('blur', concealEntry)",'function normalizeAnswers(','function normalizeGuesses(','function chooseWinner(','function submitAuthorGuess('],
...
print(json.dumps({
    ...
    'pwa_cache':cache.group(1) if cache else None,'catalog_chain':catalog_chain,'built_in_games':51,
    'release_tiers':{'core':15,'extended':13,'labs':23},'core_classic_content_version':4,
    'resume_privacy_guards_audited':True,'advanced_resume_guard_version':4,'advanced_integrity_audit_required':True,
    'quick_replacement_guard_version':2,'quick_loader_version':10,'quick_session_replacement_audit_required':True,
    'session_controls_version':5,'quick_timer_resume_audit_required':True,'quick_bfcache_resume_audit_required':True,
    'quick_background_pause_audit_required':True,'quick_hidden_snapshot_audit_required':True,
    'wave_one_quiz_audit_required':True,'wave_one_imposter_audit_required':True,'wave_one_writing_audit_required':True,
    'wave_one_playable_labs':['party-quiz','fact-or-fake','undercover-similar-word','no-word-imposter','fill-blank-battle','who-wrote-it'],
    'wave_one_shared_quiz_runner':True,'wave_one_shared_imposter_runner':True,'wave_one_shared_writing_runner':True,
    'wave_one_private_handoff_concealment':True,'wave_one_private_entry_concealment':True,
    'wave_one_reference_safe_text_content':True,'hub_safe_round_state_audited':True,'hub_accessibility_layer_audited':True,
