...
checks = {
    ...
    'runtime_v6': 'const VERSION = 6;' in tools,
    ...
    'structured_json_before_mutation': all(marker in tools for marker in (
        ...
        'registry.validateCompleteStorageValue(key, parsed)',
    ...
    'registry_unit_contract': all(marker in unit_test for marker in (
        ...
        'keySpecificStorageWrappersValidated',
        ...
        "Registry.validateCompleteStorageValue('secret-circle-party-hub-v1', { version: 999, players: [] }), false",
    )),
    'browser_runtime_version': 'version: 6, bytes: 2' in e2e_test,
    ...
    'browser_semantic_current_key_contract': all(marker in forward_e2e for marker in (
        'rejects a semantically invalid value for a current storage key before mutation',
        'version: 999',
        'Daten passen nicht zum aktuellen Speicherschema',
    )),
    ...
    'service_worker_contract': 'releaseMeta.offlineCache.production' in service_worker_test and 'completeBackupHardeningOffline' in service_worker_test,
    ...
    'docs_v57_timer_store': all(marker in docs for marker in (
        'nur die 17 aktuell registrierten exakten Storage-Keys',
        'secret-circle-party-quick-timers-v1',
        'Quick-Timer-Metadaten seit v57',
        'keinen Prompt, keine Antwort, keine Mission, keine Identität',
    )),
...
print(json.dumps({
    ...
    'registry_version': 2,
    'complete_runtime_version': 6,
    'pwa_cache': current_cache,
    'exact_current_storage_key_allowlist': True,
    'managed_storage_keys': 17,
    'quick_timer_store_managed': True,
    'future_storage_versions_preserved_on_restore': True,
    'key_specific_storage_schema_validation': True,
