...
required={
 'index.html':['manifest.webmanifest','game-engine.js','word-packs.js','Aktive Runde fortsetzen','Eigene Kategorien','App installieren','vote-screen','guess-screen','leaderboard','clear-all-data','privacy.html'],
