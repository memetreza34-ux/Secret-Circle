...
checks = {
    ...
    'cache_v29': "const CACHE='secret-circle-v29'" in sw,
    'creator_offline': all(asset in sw for asset in ('./creator.html', './game-creator.js', './creator-page.js', './creator.css')),
    ...
    'routing_v7': 'version: 7' in routing and "CREATED_KEY = 'secret-circle-party-created-games-v1'" in routing and 'createCatalog' in routing,
    ...
    'creator_syntax_gates': all(marker in package.get('scripts', {}).get('check', '') for marker in ('game-creator.js', 'creator-page.js', 'party-guide.js')),
...
for forbidden in ['eval(', 'new Function(', 'document.write(', 'http://']:
    for relative in [
        ...
        'party-mega-modes.js', 'party-viral-modes.js', 'quick-loader.js', 'party-hub.js'
    ]:
