...
checks = {
    ...
    'pwa_cache_v13': "const CACHE='secret-circle-v13'" in service_worker,
...
if len(unit_tests) < 4 or len(e2e_suites) < 11 or not cross_browser_suites:
...
for relative, markers in {
    'RELEASE_STATUS.md': ['Cache-Version 13', 'Aktuelle Blocker'],
