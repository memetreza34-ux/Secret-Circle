...
Status: **15/15 Core-Quellpass PREPARED – reale Gruppen-/Rechteabnahme offen**
...
## 3. Matrix – erster Quellpass abgeschlossen
...
| Wahrheit oder Pflicht | teen | PREPARED | Private-Device-Fund `SC-CONTENT-PRIV-001` geschlossen; Built-in-Pflichten sind kurze harmlose Kreativ-/Darstellungs-/Reflexionsaufgaben | Ton in realer Gruppe, finaler Sign-off |
...
| Scharade | all | PREPARED | Begriffe wie Boxen/Klettern/Tauchen sind **nur pantomimisch darzustellende Begriffe**, keine Aufforderung zur echten Aktivität | physische Verständlichkeit/Barrierefreiheit real testen |
...
| Heiße Kartoffel | all | PREPARED | Mini-Aufgaben sind niedrig-riskant: zählen, nennen, Geräusch, leichte Bewegung | Geräteweitergabe/Tempo real testen |
...
| Zwei Wahrheiten, eine Lüge | all | PREPARED | Built-ins sind Inspirationsprompts; Nutzer bestimmen ihre persönlichen Aussagen selbst | Freiwilligkeitscopy real verifizieren, Gruppentest |
...
Diese Regel ist inzwischen in `party.html` vor dem Start eines Hub-Spiels und in `advanced.html` sichtbar verankert. Reale Nutzerprüfung bleibt offen.

## 6. Befund nach 15/15 Quellpass
...
- kein bekannter finaler Core-Prompt, der private Chats/Kamerarolle verlangt
- kein bekannter Core-Prompt, der Passwörter/Adressen/Kontodaten verlangt
- Mafia bleibt bewusst `teen`
- Paranoia/Truth-Dare/Never-Have bleiben bewusst `teen`
- alle 15 Core-Games besitzen mindestens den Status `PREPARED` im Quellreview

Dies ist eine **redaktionelle Quellbewertung**, kein realer Nutzer-, Store- oder Rechtsnachweis.
...
- [ ] Skip/Freiwilligkeit in persönlichen Core-Flows real verifizieren
...
Bis dahin bleibt der Gesamtbereich **CONTENT IN PROGRESS**, obwohl der erste 15/15-Quellpass abgeschlossen ist.
